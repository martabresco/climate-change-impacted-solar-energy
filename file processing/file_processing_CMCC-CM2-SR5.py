...
def main(): 
    ...
    folder_path = "/groups/FutureWind/SFCRAD/CMCC-ESM2/ssp585/r1i1p1f1/" #remember to change depending on model
    ...
    for overlap_start, overlap_end, tas_file, rsds_file, rsdsdiff_file in final_overlaps:
        ...
        if 'time' in ds.dims:
            ...
            for year in unique_years:
                ...
                output_file = f"/groups/FutureWind/SFCRAD/CMCC-ESM2/ssp585/r1i1p1f1/rsds_rsdsdiff_tas_{year}.nc" #remember to change depending on model
